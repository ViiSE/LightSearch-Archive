...
@Component("lightsearch.client.bot.processor.ProcessorConnectionSystemDefaultImpl")
@Scope("prototype")
public class ProcessorConnectionSystemDefaultImpl implements Processor {
    
    private final String IDENTIFIER = CommandType.IDENTIFIER.toString();
    private final String SYSTEM     = CommandContentType.SYSTEM.toString();
