...
public class ClientHandlerDTODataProviderProcessor implements DataProviderProcessor {
    ...
    public Object apply(Object... ignore) {
        ...
        ClientParametersHolder clientParamHolder = DataProviderCreator.createDataProvider(ClientParametersHolder.class,
                serverDTO);
        ...
        return ClientHandlerDTOInit.clientHandlerDTO(
