...
public class RestartProcessorTestNG {
    ...
    @Test
    @Parameters({"restartMessage", "logDirectoryName", "openTest"})
    public void apply(String message, String logDirectoryName, boolean openTest) {
        testBegin("RestartProcessor", "apply()");
        ...
        testEnd("RestartProcessor", "apply()");
    }
}
