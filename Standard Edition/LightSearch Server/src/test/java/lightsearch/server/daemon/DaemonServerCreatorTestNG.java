 ...
 * @author ViiSE
 */
public class DaemonServerCreatorTestNG {
    
    @Test
    public void createDaemonServer() {
        testBegin("DaemonServerCreator", "createDaemonServer()");
        ...
        System.out.println("daemonServer: " + daemonServer);
        
        testEnd("DaemonServerCreator", "createDaemonServer()");
    }
}
