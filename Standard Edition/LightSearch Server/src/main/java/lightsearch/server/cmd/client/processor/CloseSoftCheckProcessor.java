...
/**
 * Обработчик команды закрытия мягкого чека.
 * @author ViiSE
 * @since 2.0.0
 */
public class CloseSoftCheckProcessor extends AbstractProcessorClient {
    
    private final ClientDAO clientDAO;
    private final CurrentDateTime currentDateTime;
    private final DatabaseRecordIdentifier databaseRecordIdentifier;
    
    public CloseSoftCheckProcessor(LightSearchServerDTO serverDTO, LightSearchChecker checker,
