 ...
 * @author ViiSE
 */
public class ProcessorOpenSoftCheckDefaultImplTestNG {
    ...
    @BeforeClass
    @Parameters({"ip", "port", "answerOpenSC"})
    ...
    public void apply(long delayMessageDisplay) {
        testBegin("ProcessorOpenSoftCheckDefaultImpl", "apply()");
        ...
        Processor proc = new ProcessorOpenSoftCheckDefaultImpl();
        proc.apply(botDAO, msgSender, msgRecipient, delayMessageDisplay);
        
        testEnd("ProcessorOpenSoftCheckDefaultImpl", "apply()");
    }
}
