 ...
 * @author ViiSE
 */
public class ProcessorConnectionDefaultImplTestNG {
    ...
    @BeforeClass
    @Parameters({"ip", "port", "answerConnection"})
    ...
    public void apply(long delayMessageDisplay) {
        testBegin("ProcessorConnectionDefaultImpl", "apply()");
        ...
        Processor proc = new ProcessorConnectionDefaultImpl();
        proc.apply(botDAO, msgSender, msgRecipient, delayMessageDisplay);
        
        testEnd("ProcessorConnectionDefaultImpl", "apply()");
    }
}
