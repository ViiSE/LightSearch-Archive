 ...
 * @author ViiSE
 */
public class AuthenticationProcessorTestNG {
    ...
    @BeforeClass
    @Parameters({"ip", "port", "authMessage", "openTest"})
    ...
    public void apply() {
        ...
        Function<AdminPanelDTO, String> processor = admCmdHolder.get(AUTHENTICATION);
        assertNotNull(processor, "AuthenticationProcessor is null!");
