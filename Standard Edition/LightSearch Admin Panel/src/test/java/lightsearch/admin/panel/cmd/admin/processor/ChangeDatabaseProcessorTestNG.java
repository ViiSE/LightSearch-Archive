...
public class ChangeDatabaseProcessorTestNG {
    ...
    private final String CHANGE_DATABASE = AdminCommandEnum.CHANGE_DATABASE.stringValue();
    ...
    @BeforeClass
    @Parameters({"ip", "port", "chDbMessage", "openTest"})
    ...
    public void apply() {
        ...
        Function<AdminPanelDTO, String> processor = admCmdHolder.get(CHANGE_DATABASE);
        assertNotNull(processor, "ChangeDatabaseProcessor is null!");
