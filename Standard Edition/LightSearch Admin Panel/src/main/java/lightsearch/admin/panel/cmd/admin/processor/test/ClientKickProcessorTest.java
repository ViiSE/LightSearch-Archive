 ...
 * @author ViiSE
 */
public class ClientKickProcessorTest extends AbstractProcessorAdmin {
    
    private final String COMMAND = MessageCommandEnum.KICK.stringValue();
    private final String TRUE    = MessageCommandResultEnum.TRUE.stringValue();
    
    private final MapRemover mapRemover;
    
    public ClientKickProcessorTest(AdminDTO adminDTO, MapRemover mapRemover) {
        super(adminDTO);
