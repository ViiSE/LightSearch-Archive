 ...
 * @author ViiSE
 */
public class MessageBlacklistJSONDefaultImpl implements MessageBlacklist {
    ...
    public MessageBlacklistJSONDefaultImpl(String name) {
        this.name = name;
    }
    ...
    public String message() {
        ...
        msgBlObj.put(COMMAND, BLACKLIST);
        msgBlObj.put(NAME, name);
        return msgBlObj.toJSONString();
    }
}
