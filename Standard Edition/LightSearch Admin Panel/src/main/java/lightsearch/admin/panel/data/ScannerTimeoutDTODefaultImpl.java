 ...
 * @author ViiSE
 */
public class ScannerTimeoutDTODefaultImpl implements ScannerTimeoutDTO {

    private final Scanner scanner;
    private final TimeoutValidator timeoutValidator;

    public ScannerTimeoutDTODefaultImpl(Scanner scanner, TimeoutValidator timeoutValidator) {
    ...
    @Override
    public TimeoutValidator timeoutValidator() {
