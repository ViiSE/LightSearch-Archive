 ...
 * @author ViiSE
 */
public class ScannerRestartDefaultImpl implements ScannerRestart {
    
    private final ScannerRestartDTO scannerDTO;
    
    public ScannerRestartDefaultImpl(ScannerRestartDTO scannerDTO) {
        this.scannerDTO = scannerDTO;
    }

    @Override
    public String scanAnswer() throws ScannerException {
        try {
