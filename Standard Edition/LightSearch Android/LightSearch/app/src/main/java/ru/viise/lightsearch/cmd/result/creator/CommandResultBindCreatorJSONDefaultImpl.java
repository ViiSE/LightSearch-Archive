...
public class CommandResultBindCreatorJSONDefaultImpl implements CommandResultCreator {
    ...
    public CommandResultBindCreatorJSONDefaultImpl(
            String rawMessage,
            String IMEI,
            int selected,
    ...
    public CommandResult createCommandResult() throws CommandResultCreatorException {
        try {
            ...
            return BindCommandResultInit
                    .bindCommandResult(isDone, message, selected, null, factoryBarcode);
