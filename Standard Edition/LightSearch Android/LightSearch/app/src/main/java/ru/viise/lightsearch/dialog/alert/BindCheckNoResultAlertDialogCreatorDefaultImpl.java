...
public class BindCheckNoResultAlertDialogCreatorDefaultImpl implements NoResultAlertDialogCreator {

    private final Activity activity;
    private final String message;

    public BindCheckNoResultAlertDialogCreatorDefaultImpl(Activity activity, String message) {
