...
import ru.viise.lightsearch.data.BindRecordInit;

public class BindRecordsCreatorJSONDefaultImpl implements BindRecordsCreator {
    ...
    public BindRecordsCreatorJSONDefaultImpl(Object data) {
        this.data = (JSONArray) data;
    }

    @Override
    public List<BindRecord> create() {
        List<BindRecord> records = new ArrayList<>();
        try {
            for(Object rec : data) {
                ...
                records.add(BindRecordInit.bindRecord(name, barcode));
            }
