...
public class MessageCancelSoftCheckJSONDefaultImpl implements MessageCancelSoftCheck {
    ...
    private final CommandCancelSoftCheckDTO cmdCSCDTO;

    public MessageCancelSoftCheckJSONDefaultImpl(String IMEI, CommandCancelSoftCheckDTO cmdCSCDTO) {
        this.IMEI = IMEI;
    ...
    public String message() {
        ...
        msgOSCObj.put(COMMAND, CANCEL_SOFT_CHECK);
