...
public class CreateSearchCommandResultRule implements TestRule {

    private SearchCommandResult searchCommandResult;
    private final List<SearchRecord> records;

    public CreateSearchCommandResultRule(List<SearchRecord> records) {
    ...
    public Statement apply(Statement base, Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                searchCommandResult = SearchCommandResultInit.searchCommandResult(
                        true, "Soft Check is closed!", records,
                        "Subdiv UI Name", null);
    ...
    public SearchCommandResult getSearchCommandResult() {
