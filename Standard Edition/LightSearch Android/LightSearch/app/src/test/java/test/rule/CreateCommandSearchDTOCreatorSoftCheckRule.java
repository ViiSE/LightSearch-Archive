...
public class CreateCommandSearchDTOCreatorSoftCheckRule implements TestRule {
    ...
    public Statement apply(Statement base, Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                cmdSearchDTOCreator = CommandSearchDTOCreatorInit.commandSearchDTOCreator(barcode);
