...
import static ru.viise.lightsearch.cmd.ClientCommandEnum.CANCEL_SOFT_CHECK;
import static test.TestMessage.catchMessage;

public class CancelSoftCheckProcessorTest implements Function<String, String> {
    ...
    public String apply(String rawMessage) {
        try {
            ...
            if(!command.equals(CANCEL_SOFT_CHECK.stringValue()))
    ...
    private String successMessage(String IMEI) {
        ...
        jAnswer.put(ClientCommandContentEnum.MESSAGE.stringValue(), "Soft Check is cancel!");
