...
public class CreateClientCommandCreatorRule implements TestRule {
        ...
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                clientCommandCreator =
                        ClientCommandCreatorInit.clientCommandCreator(IMEI, null, null);
    ...
    public ClientCommandCreator getClientCommandCreator() {
        return clientCommandCreator;
    }
}
