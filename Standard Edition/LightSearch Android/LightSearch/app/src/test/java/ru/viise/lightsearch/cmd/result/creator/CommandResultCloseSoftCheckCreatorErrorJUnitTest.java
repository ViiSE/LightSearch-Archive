...
public class CommandResultCloseSoftCheckCreatorErrorJUnitTest {

    private CommandResultCreator cmdResCr;

    @Before
    public void setUp() {
        cmdResCr = CommandResultCreatorInit.commandResultCloseSoftCheckCreator(
                false, null, "Close soft check failed.");
    }

    @Test
    public void createCommandResult() {
        testBegin("CommandResultCloseSoftCheckCreatorError", "createCommandResult()");
        ...
        try {
            ...
            assertThat(cmdRes.message()).isEqualTo("Close soft check failed.");
        ...
        testEnd("CommandResultCloseSoftCheckCreatorError", "createCommandResult()");
    }
}
