...
public class CommandResultCloseSoftCheckCreatorJSONJUnitTest {
    ...
    public void setUp() {
        ...
        String rawMessage = "{" +
                ...
                "}";
        cmdResCr = CommandResultCreatorInit.commandResultCloseSoftCheckCreator(rawMessage, IMEI);
    }

    @Test
    public void createCommandResult() {
        testBegin("CommandResultCloseSoftCheckCreatorJSON", "createCommandResult()");

        try {
            CloseSoftCheckCommandResult result =
                    (CloseSoftCheckCommandResult) cmdResCr.createCommandResult();
        ...
        testEnd("CommandResultCloseSoftCheckCreatorJSON", "createCommandResult()");
    }
}
