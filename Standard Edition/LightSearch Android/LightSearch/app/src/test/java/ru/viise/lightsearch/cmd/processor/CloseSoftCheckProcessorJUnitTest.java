...
import test.server.processor.CloseSoftCheckProcessorTest;
...
public class CloseSoftCheckProcessorJUnitTest {
    ...
    @Rule
    public final CreateCommandCloseSoftCheckDTORule commandCloseSoftCheckDTORule =
    ...
    public void setUp() throws MessageSenderException, MessageRecipientException {
        ...
        commandDTO = commandCloseSoftCheckDTORule.getCommandCloseSoftCheckDTO();
        CommandCloseSoftCheckDTO cmdDTO = commandCloseSoftCheckDTORule.getCommandCloseSoftCheckDTO();
        String rawMessage = MessageCloseSoftCheckInit.messageCloseSoftCheck(IMEI, cmdDTO).message();

        CloseSoftCheckProcessorTest closeSCProcTest = new CloseSoftCheckProcessorTest();
        doNothing().when(messageSender).sendMessage(isA(String.class));
        when(messageRecipient.acceptMessage()).thenReturn(closeSCProcTest.apply(rawMessage));
    ...
    public void apply() {
        ...
        CloseSoftCheckCommandResult result = (CloseSoftCheckCommandResult)
                new CloseSoftCheckProcessor(clientCommandDTO).apply(commandDTO);
