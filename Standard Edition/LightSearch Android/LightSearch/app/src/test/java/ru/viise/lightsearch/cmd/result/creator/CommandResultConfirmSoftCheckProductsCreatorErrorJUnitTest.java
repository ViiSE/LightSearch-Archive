...
public class CommandResultConfirmSoftCheckProductsCreatorErrorJUnitTest {
    ...
    public void setUp() {
        cmdResCr = CommandResultCreatorInit.commandResultConfirmCartProductsCreator(
                false, "Error confirm", null);
    }

    @Test
    public void createCommandResult() {
        testBegin("CommandResultConfirmSoftCheckProductsCreatorError", "createCommandResult()");
        ...
        try {
            ...
            assertThat(cmdRes.message()).isEqualTo("Error confirm");
        ...
        testEnd("CommandResultConfirmSoftCheckProductsCreatorError", "createCommandResult()");
    }
}
